...
tail = Gst.parse_launch(
    ...
    "interaudiosrc channel=tva ! audio/x-raw,rate=48000,channels=2 ! queue ! audioconvert ! audioresample "
...
def source_desc(ch):
    return (f"souphttpsrc location=http://{HDHR}:5004/auto/v{ch} is-live=true ! decodebin3 name=dec "
            ...
            "dec. ! queue ! audioconvert ! audioresample ! interaudiosink channel=tva sync=false")
