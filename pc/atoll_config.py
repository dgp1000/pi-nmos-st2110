...
_VARS = ("ATOLL_USER PI_USER ISLAND_PC_IP ISLAND_PI_IP ISLAND_PI2_IP ISLAND_IFACE PC_WIFI_IP "
         ...
         "HDHR_HOST HDHR_DEVICE_ID ATOLL_RUN TV_CHANNEL PROGRAMOUT_PORT AUDIOMAP_NMOS_PORT AUTH_PORT IS11_PORT "
         "REELS_GRP REELS_PORT PI_RAW_GRP PI_RAW_PORT PI_AUDIO_GRP PI_AUDIO_PORT "
         "TSRTP_GRP TSRTP_PORT H264_GRP H264_PORT MJPEG_GRP MJPEG_PORT VP9_GRP VP9_PORT OPUS_GRP OPUS_PORT MCAST_TTL").split()
